...
class VulnerabilityInfo(object):
    def __init__(self,Medusa):
        ...
        self.info['algroup'] = "Struts2RemoteCodeExecutionVulnerability48"  # 插件名称
        self.info['name'] ='Struts2远程代码执行漏洞48' #漏洞名称
