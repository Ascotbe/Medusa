...
def Main(Url,FileName,Values,ProxyIp):
    ...
    Medusa = [SolrVelocityTemplateRemoteCodeExecutionVulnerability.medusa(Url,RandomAgent,ProxyIp),SolrVelocityTemplateRemoteCodeExecutionVulnerability2.medusa(Url,RandomAgent,ProxyIp)]
    try:
