...
def Main(ThreadPool,Url,Values,ProxyIp):
    ...
    ThreadPool.Append(S2_005.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_008_1.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_008_2.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_009.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_019.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_020.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_032.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_033.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_037.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_057.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_046.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_048.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_045.medusa, Url, Values, ProxyIp)
    ThreadPool.Append(S2_Devmode.medusa, Url, Values, ProxyIp)
