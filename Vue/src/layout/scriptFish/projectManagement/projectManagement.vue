...
export default {
  ...
  methods: {
    ...
    handleChangePage(pagination, filters, sorter, { currentDataSource }) {
...
.projectManagement {
  ...
  /*定义整体的宽度*/
  .projectManagement_bg /deep/.ant-table-body::-webkit-scrollbar {
    height: 3px;
  }

  /*定义滚动条轨道*/
  .projectManagement_bg /deep/.ant-table-body::-webkit-scrollbar-track {
    border-radius: 5px;
  }

  /*定义滑块*/
  .projectManagement_bg /deep/.ant-table-body::-webkit-scrollbar-thumb {
    border-radius: 5px;
