...
def Main(Url,FileName,Values,ProxyIp):
    ...
    Medusa = [CitrixGatewayPathTraversalVulnerability.medusa(Url, RandomAgent, ProxyIp),
              CitrixRemoteCodeExecutionVulnerability.medusa(Url, RandomAgent, ProxyIp),]
    try:
        for i in tqdm(Medusa, ascii=True, desc="Citrix plugin progress"):
